...
public interface IRepositoryStore
{
    ...
    Task<Repository?> GetByOwnerAndSlugAsync(string ownerUsername, string slug, CancellationToken ct = default);
    Task<IReadOnlyList<Repository>> ListAsync(CancellationToken ct = default);
    Task<IReadOnlyList<Repository>> ListByOwnerAsync(Guid ownerId, CancellationToken ct = default);
