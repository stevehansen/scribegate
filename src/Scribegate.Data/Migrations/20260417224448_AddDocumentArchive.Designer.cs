...
namespace Scribegate.Data.Migrations
{
    ...
    [Migration("20260417224448_AddDocumentArchive")]
    partial class AddDocumentArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.Document", b =>
                {
                    ...
                    b.HasIndex("RepositoryId", "IsArchived");
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.DocumentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.ShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.Webhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int?>("LastDeliveryStatus")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("Enabled", "RepositoryId");

                    b.ToTable("Webhooks");
                });

            modelBuilder.Entity("Scribegate.Core.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.DocumentTemplate", b =>
                {
                    b.HasOne("Scribegate.Core.Entities.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.Repository", b =>
                {
                    b.HasOne("Scribegate.Core.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.ShareLink", b =>
                {
                    ...
                    b.HasOne("Scribegate.Core.Entities.User", "RevokedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Scribegate.Core.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("Scribegate.Core.Entities.Webhook", "Webhook")
                        .WithMany()
